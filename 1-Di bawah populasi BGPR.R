...
popBGPR=function(y1,y2,x,param,maxit,eps)
{
  norm.iter=100000
  iter=1
  ...
  while (iter<=maxit && ((alfa1<0 || alfa2<0) || norm.iter>eps))
  {
    ...
    for (i in 1:n)
    {
      fungsi1=fungsi1+(((-n/lamda0)-(3*n)))
      kk=min(y1[i],y2[i])
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi2=fungsi2+((((-y1[i]+k+1)/((miu1[i]-lamda0)+((y1[i]-k)*alfa1)))+((-y2[i]+k+1)/((miu2[i]-lamda0)+((y2[i]-k)*alfa2))))*(k-1)/(lamda0+(k*alfa0)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      fungsi1=fungsi1+(1/miu1[i]*(miu1[i]*x[i,]))
      fungsi2=fungsi2+(miu1[i]*x[i,])
      kk=min(y1[i],y2[i])
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi3=fungsi3+(((y1[i]-k-1)*miu1[i]*x[i,]/((miu1[i]-lamda0)+((y1[i]-k)*alfa1))))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      fungsi1=fungsi1+(1/miu2[i]*(miu2[i]*x[i,]))
      #print(i)
      #print((1/miu2[i]*(miu2[i]*x[i,])))
      fungsi2=fungsi2+(miu2[i]*x[i,])
      kk=min(y1[i],y2[i])
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi3=fungsi3+(((y2[i]-k-1)*miu2[i]*x[i,]/((miu2[i]-lamda0)+((y2[i]-k)*alfa2))))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      fungsi1=fungsi1+(-y1[i])
      kk=min(y1[i],y2[i])
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi2=fungsi2+((((y1[i]-k-1)*(y1[i]-k)/((miu1[i]-lamda0)+((y1[i]-k)*alfa1)))+1))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      fungsi1=fungsi1+(-y2[i])
      kk=min(y1[i],y2[i])
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi2=fungsi2+(((y2[i]-k-1)*(y2[i]-k)/((miu2[i]-lamda0)+((y2[i]-k)*alfa2))))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+((-1+(k*(k-1)/(lamda0+(k*alfa0)))))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      fungsi1=fungsi1+(n/lamda0)
      kk=min(y1[i],y2[i])
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi2=fungsi2+((((-y1[i]+k+1)/(((miu1[i]-lamda0)+((y1[i]-k)*alfa1))^2))+(((-y2[i]+k+1)/(((miu2[i]-lamda0)+((y2[i]-k)*alfa2))^2))+((k-1)/((lamda0+(k*alfa0))^2)))))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(((y1[i]-k-1)*miu1[i]*x[i,]/(((miu1[i]-lamda0)+((y1[i]-k)*alfa1))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(((y2[i]-k-1)*miu2[i]*x[i,]/(((miu2[i]-lamda0)+((y2[i]-k)*alfa2))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(((y1[i]-k)*(y1[i]-k-1)/(((miu1[i]-lamda0)+((y1[i]-k)*alfa1))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(((y2[i]-k)*(y2[i]-k-1)/(((miu2[i]-lamda0)+((y2[i]-k)*alfa2))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(((-k*(k-1))/((lamda0+(k*alfa0))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(x[i,]%*%t(x[i,])*miu1[i]*(1+((-y1[i]+k+1)*miu1[i]/(((miu1[i]-lamda0)+((y1[i]-k)*alfa1))^2))+((y1[i]-k-1)/((miu1[i]-lamda0)+((y1[i]-k)*alfa1)))))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(x[i,]%*%t(x[i,])*miu2[i]*(1+((-y2[i]+k+1)*miu2[i]/(((miu2[i]-lamda0)+((y2[i]-k)*alfa2))^2))+((y2[i]-k-1)/((miu2[i]-lamda0)+((y2[i]-k)*alfa2)))))
        }
      }
    }
    ...
    if (kk!=0)
    {for (k in  0:kk)
    {fungsi1=fungsi1+(((-y1[i]+k)*(y1[i]-k-1)*miu1[i]*x[i,]/(((miu1[i]-lamda0)+((y1[i]-k)*alfa1))^2)))}}
    }
    ...
    if (kk!=0)
    {for (k in  0:kk)
    {fungsi1=fungsi1+(((-y2[i]+k)*(y2[i]-k-1)*miu2[i]*x[i,]/(((miu2[i]-lamda0)+((y2[i]-k)*alfa2))^2)))}}
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+((((y1[i]-k)^2)*(-y1[i]+k+1)/(((miu1[i]-lamda0)+((y1[i]-k)*alfa1))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+((((y2[i]-k)^2)*(-y2[i]+k+1)/(((miu2[i]-lamda0)+((y2[i]-k)*alfa2))^2)))
        }
      }
    }
    ...
    for (i in 1:n)
    {
      ...
      if (kk!=0)
      {
        for (k in  0:kk)
        {
          fungsi1=fungsi1+(((-(k^2))*(k-1)/(lamda0+(k*alfa0))))
        }
      }
    }
...
Q_BGPR=function(y1,y2,x,param)
{
  ...
  {
    A1=A1+(log(miu0))
    A2=A2+(log(abs(miu1[i]-miu0)))
    A3=A3+(log(abs(miu2[i]-miu0)))
    A4=A4+(miu0)
    A5=A5+((miu1[i]-miu0))
    A6=A6+((miu2[i]-miu0))
    A7=A7+(y1[i]*alfa1)
